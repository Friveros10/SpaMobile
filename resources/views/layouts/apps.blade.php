...
<div class="d-flex " id="wrapper">
    ...
    <div class="  " style="background-color:#000; color:#fff " id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="#" class="list-group-item list-group-item-action bg-light "><i class="icon-google size-10px" style="color:#000"></i> </a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><span class="icon-logout"></span>Shortcuts</a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><h4>Ver Historial</h4></a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><h4>Registrar usuario</h4></a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><h4>Ver Usuarios</h4></a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><h4>SAlir</h4></a>
      </div>
    </div>
    <!-- Page Content -->
