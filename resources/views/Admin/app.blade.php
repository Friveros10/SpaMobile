...
<head>
    ...
    <!-- Iconos -->
   <!--  <link href="{{asset('/icons/style.css?v=1.0.4')}}" rel="stylesheet" type="text/css"> -->
...
<div class="d-flex " id="wrapper">
    ...
    <div class="  " style="background-color:#000; color:#fff " id="sidebar-wrapper">
      <div class="sidebar-heading">
          <img src="{{ asset('assets/img/brand/spamobile.png')}}" style="padding-top: 10px; padding-bottom: 20px; padding-right: 10px; padding-left: 20px;" class="navbar-spaMobile"  >
      </div>
      <div class="list-group list-group-flush">
        <a href="#" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;"> <h4>Menu</h4> </a>
        <a href="/users" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;"><h4>Gestión Usuarios</h4></a>
        <a href="/MisLocales" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;"><h4>Gestión Locales</h4></a>
        <a href="/bandejas" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;"><h4>Gestión Bandejas</h4></a>
        <a href="/about" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;"><h4>About</h4></a><br><br<br><br><br><br><br><br><br><br>
        <a href="{{ route('logout') }}" class="list-group-item list-group-item-action" style="background-color: #000; color:#fff;" onclick="event.preventDefault();
                          document.getElementById('logout-form').submit();">
        <span class=" btn btn-xs glyphicon glyphicon-log-out"><h4>Cerrar Sesion</h4></span> </a>
      </div>
    </div>
    <!-- Page Content -->
